# A Guide to Music Track Reviewing for SAG

This contains the most important information for you as a reviewer, including what questions to consider or what to include in a review.

## Writing a SAG music track review

Reviews are an essential part of feedback to submitters. The central, guiding question for all reviews is this: **Does this submission present an original, important, inspiring and useful enhancement to the community knowledge?**

With this question in mind, here’s a guide to writing a SAG review.
...
It seems self-explanatory, but it’s important to read the submission PDF accompanying the media examples, in its entirety. Some works require contextualization to be properly evaluated, and the document is expected to explain the concept and thoughts behind the work, the technologies used, and its connection to spatial audio research. It should also describe the technical setup.
...
4. To offer a perspective on whether the submission makes a valid, meaningful contribution to the artistic program of SAG.
5. To give an indication of the atmosphere and requirements for the piece or art-installation.
  ...
  b. An indication of the need of other special technical requirements.
...
Finally, state your recommendation (Strong Accept, Accept, Weak Accept, Borderline, Weak Reject, Reject, Strong Reject). Clearly state why you are making this recommendation.

## Some FAQs on reviewing
...
For the Art track, this can range from 100 to 250 words.

### If the composition/performance/installation is great, do I need to submit a detailed review?
...
### What makes a composition/performance/installation unreviewable?
...
Since SAG is dependent on reviews to select the proceedings, we ask you to please submit your reviews if you have committed to reviewing for this year’s SAG. 

If for some reason reviewing is impossible, please tell the chairs as soon as possible so another reviewer can be found.
